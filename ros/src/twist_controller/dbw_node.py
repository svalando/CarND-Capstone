    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            if self.enabled:
                ...
                rospy.loginfo('Last sample time     secs=%d, nsecs=%d', self.last_sample_time.secs,
                              self.last_sample_time.nsecs)
                rospy.loginfo('Final waypoints time secs=%d, nsecs=%d', self.last_final_wp_time.secs,
                              self.last_final_wp_time.nsecs)
